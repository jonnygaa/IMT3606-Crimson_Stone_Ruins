...
func update_visual():
	...
	$Label3D.text = text
	$Sprite3D.texture = preload("res://addons/SimpleTutorial/res/error-sign.svg") if text.begins_with("Error") else preload("res://addons/SimpleTutorial/res/warning-sign.svg")
