...
func update_grid():
	...
	%Front.mesh.material.shader = preload("res://addons/SimpleTutorial/debug_visuals/WireframeCubeDepthEnabled.gdshader") if enable_depth_test else preload("res://addons/SimpleTutorial/debug_visuals/WireframeCube.gdshader")
	%Right.mesh.material.shader = preload("res://addons/SimpleTutorial/debug_visuals/WireframeCubeDepthEnabled.gdshader") if enable_depth_test else preload("res://addons/SimpleTutorial/debug_visuals/WireframeCube.gdshader")
	%Top.mesh.material.shader = preload("res://addons/SimpleTutorial/debug_visuals/WireframeCubeDepthEnabled.gdshader") if enable_depth_test else preload("res://addons/SimpleTutorial/debug_visuals/WireframeCube.gdshader")
